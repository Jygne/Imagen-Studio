...
from app.domain.enums import Provider, OpenAIModel, ImageSize, ImageQuality
...
class AppSettings:
    ...
    default_model: str = OpenAIModel.GPT_IMAGE_1_5
    default_size: ImageSize = ImageSize.SIZE_1024
...
class GoogleSheetConfig:
    spreadsheet_url: str = ""
    spreadsheet_id: str = ""
    clean_tab: str = "Sheet1"
    selling_point_tab: str = "Sheet2"
