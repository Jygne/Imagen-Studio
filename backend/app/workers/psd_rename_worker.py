...
def build_rename_jsx(
    ...
    return f"""// Auto-generated by Imgen Studio PSD Rename Worker
#target photoshop
...
def run_photoshop_jsx(jsx_code: str, jsx_log_path: str) -> subprocess.Popen:
    ...
    返回 Popen 句柄供调用方轮询。
    """
    jsx_path = os.path.join(tempfile.gettempdir(), "imgen_psd_rename.jsx")
    ...
    as_path = os.path.join(tempfile.gettempdir(), "imgen_psd_rename.applescript")
